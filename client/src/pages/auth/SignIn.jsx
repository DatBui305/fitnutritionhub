...
const SignIn = () => {
  ...
  const handleSignin = async (e) => {
    ...
    try {
      ...
      window.location.href = "/question/createquestion";
    } catch (error) {
      // Xử lý lỗi đăng nhập
  ...
  return (
    <div className="flex flex-row bg-[#FAF8F6]">
      ...
      <div className="w-1/2 h-screen ">
        <h1 className="font-lobster text-[#6374AE] text-7xl px-10 pt-10 pb-20">
          Sign In
        </h1>
        <form onSubmit={handleSignin}>
          ...
          {/* forgot password */}
          <div className="flex flex-row justify-between items-center px-10 pb-20">
            <div className="flex flex-row items-center">
              <div className="bg-[#6374AE] w-[60px] h-[60px] rounded-[15px] justify-center items-center flex">
                <svg
                  width="38"
                  height="38"
                  viewBox="0 0 38 38"
                ...
                >
                  <path
                    d="M7.9165 19L15.8332 26.9167L31.6665 11.0833"
                    stroke="#F2F7FB"
                    stroke-width="3"
              ...
              <h1 className="text-[#6374AE] font-wixmadefor text-3xl font-semibold pl-3">
                Remember me
              </h1>
            </div>

            <h1 className="text-[#6374AE] font-wixmadefor text-3xl font-semibold underline underline-offset-4">
              Forgot password?
            </h1>
          </div>
        ...
        <div className="px-10 pb-5">
          <Link to="/signup">
            <button className="flex items-center justify-evenly bg-[#F2F7FB] rounded-[15px] w-full h-[70px] font-wixmadefor text-3xl font-bold text-[#6374AE] border-[3px] border-[#6374AE]">
              ...
              {/*can le*/}
              <div className="w-1"></div>
              <h1 className="text-center ">Need an account? This way</h1>
              <svg
                width="52"
                height="50"
                viewBox="0 0 52 50"
