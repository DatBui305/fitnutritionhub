...
const PostItemSuperLarge = () => {
  return (
    <div className="w-3/5 h-[575px] bg-[#F2F7FB] rounded-[30px] border-[3px] border-[#6374AE]">
      ...
      <h1 className="text-3xl text-[#262C40] font-bold px-5 pb-1">
        Wholesome Eats: Nutritious Recipes to Keep You Energized and Healthy{" "}
      </h1>
      <p className="text-xl text-[#262C40] font-normal px-5 pb-3">
        Eating well doesn’t have to be complicated! With the right balance of
        ingredients, you can prepare meals that are both delicious and packed
        with the nutrients your body needs to stay energized and healthy. In
        this post, we’re sharing some wholesome recipes that will nourish your
        body and keep you feeling great throughout the day.
      </p>
      <p className="text-xl text-[#262C40] font-normal px-5">
        1. Green Power Smoothie Start your day with this vibrant,
        nutrient-packed smoothie! It’s loaded with leafy greens, fruits, and
        healthy fats to fuel your morning. <br />
        Ingredients: <br />1 cup fresh spinach <br />
        1/2 cup kale <br />1 banana 1/2 cup frozen mango <br />1 tablespoon chia
        seeds 1/2 avocado <br />1 cup unsweetened almond milk Ice cubes
        (optional)
      </p>
      <h2 className="text-xl text-[#6374AE] font-normal px-5 py-1 underline">
        Read the whole post...
      </h2>
...
export default PostItemSuperLarge;
