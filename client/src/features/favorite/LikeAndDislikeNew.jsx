  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/v1/question/like/${question._id}`,
        {},
        {
          headers: {
      ...
      <div className="flex flex-row w-full justify-between">
        <div className="pr-5 w-1/2">
          <button
            ...
            className="w-full h-[70px] border-[3px] bg-[#6374AE] border-[#6374AE] rounded-[15px] font-wixmadefor text-2xl font-bold text-[#F2F7FB]"
          >
            Love this!
          </button>
        </div>
